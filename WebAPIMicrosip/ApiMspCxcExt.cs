...
namespace WebAPIMicrosip
{
    public class ApiMspCxcExt
    {
        ...
        [DllImport("ApiMicrosip.dll", SetLastError = true)]
        public static extern int SetDBMetadatos(int DBHandle);
        ...
        //function NuevoAnticipoCc(ConceptoCcId: Integer; Fecha, Folio: PChar;
        // ClienteId: Integer; Referencia, Descripcion: PChar; CondPagoId: Integer;
        // Importe: Double; ImpuestoId, PLHandle: Integer): Integer; stdcall;
        [DllImport("ApiMicrosip.dll", SetLastError = true)]
        public static extern int NuevoAnticipoCc(int ConceptoCcId, string Fecha, string Folio,
          int ClienteId, string Referencia, string Descripcion, int CondPagoId, double Importe, int ImpuestoId, int PLHandle);

        // function AplicaAnticipoCc: Integer; stdcall;
        [DllImport("ApiMicrosip.dll", SetLastError = true)]
        public static extern int AplicaAnticipoCc();
